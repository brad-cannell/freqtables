...
testthat::context("test-format_table.R")
...
testthat::test_that("Dimensions of the object returned by format_table are as expected", {
  dims <- dim(df)
  testthat::expect_equal(dims, c(2L, 3L))
})

testthat::test_that("The correct var name is returned by format_table", {
  var <- pull(df, var) %>% unique()
  testthat::expect_match(var, "am")
})
...
testthat::test_that("Dimensions of the object returned by format_table are as expected", {
  dims <- dim(df)
  testthat::expect_equal(dims, c(4L, 5L))
})
...
testthat::test_that("The correct var name is returned by format_table", {
  ...
  testthat::expect_match(col_var, "vs")
})
